...
// @public
export function acquire<T extends StateContainerConstructor>(BlocClass: T, opts?: {
    args?: ExtractArgs<T>;
    refId?: string;
}): InstanceType<T>;
...
// @public
export function blac(options: BlacOptions): <T extends new (...args: any[]) => any>(target: T, _context?: ClassDecoratorContext) => T;
...
// @public
export type BlocConstructor<S extends object = any, T extends new (...args: any[]) => StateContainer<S, any, any> = new (...args: any[]) => StateContainer<S, any, any>> = (new (...args: any[]) => InstanceType<T>) & {
    keepAlive?: boolean;
};
...
// @public (undocumented)
export function borrow<T extends StateContainerConstructor>(BlocClass: T, target?: BorrowTarget<T>): InstanceType<T>;

// @public (undocumented)
export function borrowSafe<T extends StateContainerConstructor>(BlocClass: T, target?: BorrowTarget<T>): {
    error: Error;
    instance: null;
} | {
    error: null;
...
// @public
export abstract class Cubit<S extends object = any, Args = void, Deps extends object = Record<string, never>> extends StateContainer<S, Args, Deps> {
}
...
// @public
export function ensure<T extends StateContainerConstructor>(BlocClass: T, opts?: {
    args?: ExtractArgs<T>;
}): InstanceType<T>;
...
// @public
export type ExtractArgs<T> = T extends new () => StateContainer<any, infer A, any> ? A : void;

// @public
export type ExtractConstructorArgs<T> = T extends new (...args: infer P) => any ? P : never[];

// @public
export type ExtractDeps<T> = T extends new () => StateContainer<any, any, infer D> ? D : Record<string, never>;
...
// @public (undocumented)
export function forEach<T extends StateContainerConstructor>(BlocClass: T, callback: (instance: InstanceReadonlyState<T>) => void): void;

// @public (undocumented)
export function getAll<T extends StateContainerConstructor>(BlocClass: T): InstanceReadonlyState<T>[];
...
// @public (undocumented)
export function getRefCount<T extends StateContainerConstructor>(BlocClass: T, opts?: {
    args?: ExtractArgs<T>;
}): number;

// @public (undocumented)
export function getRefIds<T extends StateContainerConstructor>(BlocClass: T, opts?: {
    args?: ExtractArgs<T>;
}): string[];
...
// @public (undocumented)
export function hasInstance<T extends StateContainerConstructor>(BlocClass: T, opts?: {
    args?: ExtractArgs<T>;
}): boolean;
...
// @public
export function instance<T extends StateContainerConstructor>(BlocClass: T, args?: ExtractArgs<T>): BlocRef<T>;
...
// @public
export function isExcludedFromDevTools<T extends StateContainerConstructor>(Type: T): boolean;

// @public
export function isKeepAliveClass<T extends StateContainerConstructor>(Type: T): boolean;

// @public
export type LifecycleEvent = 'created' | 'stateChanged' | 'disposed' | 'refAcquired' | 'refReleased' | 'depsChanged' | 'hydrationChanged';

// @public
export type LifecycleListener<E extends LifecycleEvent> = E extends 'created' ? (container: StateContainer<any, any, any>) => void : E extends 'stateChanged' ? (container: StateContainer<any, any, any>, previousState: any, currentState: any) => void : E extends 'disposed' ? (container: StateContainer<any, any, any>) => void : E extends 'refAcquired' ? (container: StateContainer<any, any, any>, refId: string) => void : E extends 'refReleased' ? (container: StateContainer<any, any, any>, refId: string) => void : E extends 'depsChanged' ? (container: StateContainer<any, any, any>, previousDeps: Readonly<Record<string, unknown>>, currentDeps: Readonly<Record<string, unknown>>) => void : E extends 'hydrationChanged' ? (container: StateContainer<any, any, any>, status: HydrationStatus, previousStatus: HydrationStatus) => void : never;
...
// @public (undocumented)
export function register<T extends StateContainerConstructor>(BlocClass: T): void;

// @public
export function release<T extends StateContainerConstructor>(BlocClass: T, opts?: {
    args?: ExtractArgs<T>;
    refId?: string;
...
// @public
export function resolveInstanceKey<T extends StateContainerConstructor>(BlocClass: T, args?: ExtractArgs<T>): string;
...
// @public
export abstract class StateContainer<S extends object = any, Args = void, Deps extends object = Record<string, never>> extends StructuralContainer<S> {
    ...
    protected depend<T extends StateContainerConstructor>(Type: T, defaultArgs?: ExtractArgs<T>): DepHandle<T>;
    // (undocumented)
...
// @public
export type StateContainerConstructor<S extends object = any> = new (...args: any[]) => StateContainer<S, any, any>;

// @public (undocumented)
export type StateContainerInstance<S extends object = any> = Omit<StateContainer<S, any, any>, 'state'> & {
    state: Readonly<S>;
};
...
export class StateContainerRegistry {
    ...
    // (undocumented)
    emit(event: 'stateChanged', container: StateContainer<any, any, any>, previousState: any, currentState: any): void;
    // (undocumented)
    emit(event: 'refAcquired', container: StateContainer<any, any, any>, refId: string): void;
    // (undocumented)
    emit(event: 'refReleased', container: StateContainer<any, any, any>, refId: string): void;
    // (undocumented)
    emit(event: 'depsChanged', container: StateContainer<any, any, any>, previousDeps: Readonly<Record<string, unknown>>, currentDeps: Readonly<Record<string, unknown>>): void;
    // (undocumented)
    emit(event: 'hydrationChanged', container: StateContainer<any, any, any>, status: HydrationStatus, previousStatus: HydrationStatus): void;
    // @internal
    ensure<T extends StateContainerConstructor = StateContainerConstructor>(Type: T, instanceKey?: string, args?: unknown): InstanceType<T>;
    ...
    // @internal
    getRefIds<T extends StateContainerConstructor>(Type: T, instanceKey?: string): string[];
    ...
    // @internal
    insertInstance<T extends StateContainerConstructor>(Type: T, instanceKey: string, instance: InstanceType<T>, refs?: Map<string, number>): void;
    // @internal
    notifyStateChanged(container: StateContainer<any, any, any>, previousState: any, newState: any): void;
    ...
    // @internal
    release<T extends StateContainerConstructor>(Type: T, instanceKey?: string, forceDispose?: boolean, refId?: string): void;
    resolveKey<T extends StateContainerConstructor = StateContainerConstructor>(Type: T, instanceKey: string | undefined, args: unknown): string;
}
