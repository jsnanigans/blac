...
console.log(
  "The issue is that getSnapshot returns a proxy but doesn't complete tracking",
);
console.log('The component accesses the proxy during render');
console.log(
  'But completeDependencyTracking is called in useEffect AFTER render',
);
console.log(
  'So the first state change happens before dependencies are recorded',
);
