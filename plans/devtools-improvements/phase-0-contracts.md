...
- `packages/devtools-ui/src/components/CopyButton.tsx` *(new)*
- `packages/devtools-ui/src/utils/clipboard.ts` *(new)*
...
So Phase 1C / Phase 2 / Phase 3 only *call* these, never edit the bloc.
