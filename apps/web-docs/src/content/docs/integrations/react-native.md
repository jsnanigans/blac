---
title: React Native
description: BlaC's core and React bindings run in React Native unchanged — the one feature that needs a platform adapter is persistence, with an AsyncStorage adapter example.
---
