---
title: Coming from flutter_bloc
description: How the flutter_bloc mental model maps onto BlaC, with concept mappings and a side-by-side counter port from Dart to TypeScript.
---
