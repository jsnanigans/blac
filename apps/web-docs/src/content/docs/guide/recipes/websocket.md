...
description: Open a WebSocket in a Cubit's init, push frames into state with patch, and close the socket on the dispose system event so it is always cleaned up.
---
