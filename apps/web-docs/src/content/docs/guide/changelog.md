---
title: Changelog
description: Per-package release history for the BlaC monorepo, where core packages track the 2.0.x stream and DirtyTalk packages ship independently on 0.0.x.
---
...
See the [Versioning & Stability](/guide/versioning) page for the full policy.
...
[Versioning & Stability](/guide/versioning) for what this means in practice.
