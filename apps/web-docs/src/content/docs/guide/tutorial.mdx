...
import {
  tutorialInteractiveFiles,
  tutorialTimeTravelFiles,
} from '../../../components/demos/tutorial-sandpack-files.ts';
...
- [Bloc Communication](/core/bloc-communication) — composing blocs with `depend()`.
