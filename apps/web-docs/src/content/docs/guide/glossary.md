---
title: Glossary
description: A one-line definition for every term in the BlaC docs, grouped and alphabetized, with a link to the page that explains each in full.
---
...
| Term                    | Definition                                                                                                                                                                                                                                       |
| ----------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **StateContainer**      | The abstract base class for all state holders. Holds state, declares `emit`/`patch`/`update` as **protected**, manages subscriptions, deps, and lifecycle. You rarely extend it directly. See [Cubit](/core/cubit).                              |
| **Cubit**               | The concrete class you extend. It is `StateContainer` with `emit`/`patch`/`update` re-declared **public**, so a caller can drive state from outside. See [Cubit](/core/cubit).                                                                   |
...
- **`Cubit`** — the concrete class you extend; `StateContainer` with mutation made public.
