---
title: DirtyTalk
description: A family of small, framework-agnostic libraries answering one question after every mutation — what changed, who cares, and when do we tell them?
---
