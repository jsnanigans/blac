---
title: Concepts
description: The model behind @dirtytalk/engine — why a region carries what changed, the Space algebra, the four schedulers, and the DirtyChannel flush lifecycle.
---
