  ...
  theme: {
    ...
    extend: {
      fontFamily: {
        ...
        display: ['var(--font-display)', 'var(--font-sans)', 'ui-sans-serif', 'system-ui', '-apple-system', 'BlinkMacSystemFont', '"Segoe UI"', 'sans-serif'],
      ...
      boxShadow: {
        ...
        elevated: "0 8px 24px -12px rgba(15, 23, 42, 0.2)",
        float: "0 24px 48px -24px rgba(15, 23, 42, 0.35)",
      },
    },
  },
