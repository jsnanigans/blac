...
function InteractiveComparison() {
  ...
  const handleIncrement = () => {
    ...
    const newCount =
      (activeImpl === 'cubit' ? cubitState.count : blocState.count) + 1;
    ...
    >
      ...
      <ArticleSection theme="bloc" id="introduction">
        <Prose>
          ...
          <p>
            <strong>BlaC provides two ways to manage state</strong>: Cubits and
            Blocs. They both solve the same problem—managing application
            state—but they do it in different ways.
          </p>
          <p>
            Think of it like choosing between a car and a motorcycle. Both get
            you where you need to go, but one is simpler and more direct, while
            the other has more features and capabilities. Let's explore which
      ...
      <ArticleSection id="comparison">
        ...
        <Prose>
          <p>
            Switch between Cubit and Bloc implementations below to see how they
            differ. Both counters work identically from the user's perspective,
            but the underlying code is quite different.
          </p>
        </Prose>
        <div className="my-8">
      ...
      <ArticleSection theme="neutral" id="decision-matrix">
        ...
        <Prose>
          <p>
            Here's a comprehensive comparison to help you decide between Cubit
            and Bloc for your use cases:
          </p>
        </Prose>
              ...
              <tbody>
                <tr className="border-b">
                  ...
                  <td className="p-3 text-green-600 dark:text-green-400">
                    YES: Simpler, less boilerplate
                  </td>
                  <td className="p-3 text-yellow-600 dark:text-yellow-400">
                    WARNING: More setup required
                  </td>
                </tr>
                <tr className="border-b">
                  ...
                  <td className="p-3 text-green-600 dark:text-green-400">
                    YES: Named events, clear history
                  </td>
                </tr>
                <tr className="border-b">
                  <td className="p-3 font-medium">Debugging</td>
                  <td className="p-3 text-yellow-600 dark:text-yellow-400">
                    WARNING: Standard debugging
                  </td>
                  <td className="p-3 text-green-600 dark:text-green-400">
                    YES: Event logs, time-travel
                  </td>
                </tr>
                <tr className="border-b">
                  <td className="p-3 font-medium">Testing</td>
                  <td className="p-3 text-green-600 dark:text-green-400">
                    YES: Test methods directly
                  </td>
                  <td className="p-3 text-green-600 dark:text-green-400">
                    YES: Test events & handlers
                  </td>
                </tr>
                <tr className="border-b">
      ...
      <ArticleSection theme="cubit" id="code-comparison">
        ...
        <Prose>
          <p>
            Let's look at the actual implementation differences. Notice how
            Cubit is more concise, while Bloc is more explicit about what's
            happening:
          </p>
        </Prose>
        ...
        <div className="my-8 space-y-6">
          <div>
            <h4 className="text-lg font-semibold mb-4 text-concept-cubit">
              Cubit Implementation
            </h4>
            <CodePanel
...
cubit.increment(); // Direct call`}
          ...
          <div>
            <h4 className="text-lg font-semibold mb-4 text-concept-bloc">
              Bloc Implementation
            </h4>
            <CodePanel
...
bloc.add(new IncrementEvent()); // Explicit event`}
      ...
      <ArticleSection theme="info" id="decision-guide">
        ...
        <Prose>
          <p>
            Still not sure which to choose? Here's a practical guide based on
            real-world scenarios:
          </p>
        </Prose>

        <div className="my-8 space-y-4">
          <ConceptCallout type="tip" title="Choose Cubit When:">
            ...
            <p className="mt-3 text-sm font-semibold">
              Example: A search filter component, theme toggle, or pagination
              state
            </p>
          </ConceptCallout>

          <ConceptCallout type="tip" title="Choose Bloc When:">
            <ul className="list-disc list-inside space-y-1 text-sm">
            ...
            <p className="mt-3 text-sm font-semibold">
              Example: Authentication flow, shopping cart, or multi-step form
              wizard
            </p>
          </ConceptCallout>
          ...
          >
            <p className="text-sm">
              Start with Cubit for simplicity. You can always migrate to Bloc
              later when you need event tracking or complex logic. Since they
              share the same API (<code>useBloc</code> hook), migration is
              straightforward—just change the implementation, not the usage!
            </p>
          </ConceptCallout>
        </div>
      </ArticleSection>
      ...
      <ArticleSection theme="success" id="takeaways">
        ...
        <Prose>
          <ul>
            <li>
              <strong>Cubit is simpler</strong>: Less code, direct method calls,
              perfect for straightforward state
            </li>
            <li>
              <strong>Bloc is more powerful</strong>: Event-driven, traceable,
              better for complex business logic
            </li>
            <li>
              <strong>Both are equally valid</strong>: Choose based on your
              needs, not on "best practices"
            </li>
            <li>
              <strong>Migration is easy</strong>: The same React API works with
              both, so you can change your mind later
            </li>
            <li>
              <strong>Performance difference is minimal</strong>: Don't choose
              based on performance unless you're building something extremely
      ...
      <ArticleSection theme="neutral" id="next-steps">
        ...
        <Prose>
          <p>
            Now that you understand the trade-offs between Cubit and Bloc,
            you're ready to make informed decisions about your state management
            architecture. Here's what to explore next:
          </p>
          <ul>
            <li>
              <strong>Computed Properties</strong>: Learn how to derive values
              from your state efficiently
            </li>
            <li>
              <strong>State Composition</strong>: Discover how to combine
              multiple Blocs and Cubits
            </li>
            <li>
              <strong>Testing Strategies</strong>: Master testing patterns for
              both approaches
            </li>
          </ul>
          <p className="mt-4">
            Remember:{' '}
            <strong>most applications benefit from using both patterns</strong>.
            Use Cubit for simple state and Bloc for complex flows. There's no
