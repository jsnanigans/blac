  ...
  return (
    <div className="space-y-4">
      ...
      <div className="text-sm text-muted-foreground">
        {state.tasks.filter((t) => t.completed).length} of {state.tasks.length}{' '}
        completed
      </div>
    </div>
  );
  ...
  return (
    ...
    >
      ...
      <ArticleSection theme="cubit" id="introduction">
        <Prose>
          ...
          <p>
            ...
            <strong>prop drilling</strong>—passing props through multiple layers
            of components just to get data where it's needed.
          </p>
          <p>
            With BlaC, child components can access shared state directly,
            without any props. The parent doesn't need to know what data its
            children need, and children don't need to receive endless prop
            lists.
          </p>
        </Prose>
        ...
        <TipCallout title="Component Independence">
          <p>
            In BlaC, components are <strong>independent consumers</strong> of
            state. They connect directly to the Cubit they need, making them
            easier to test, move, and reuse.
          </p>
        </TipCallout>
      </ArticleSection>
      ...
      <ArticleSection id="demo">
        ...
        <Prose>
          <p>
            Below is a task list built with parent and child components. Notice
            how TaskItem and AddTaskForm components can update state without
            receiving any callback props!
          </p>
        </Prose>
        ...
        <InfoCallout title="What You're Seeing">
          <p>
            The <code>TaskList</code> parent renders <code>TaskItem</code>{' '}
            children, and the <code>AddTaskForm</code> is a sibling. Yet all
            three components can read and update the same state—no props
            required!
          </p>
        </InfoCallout>
      </ArticleSection>
      ...
      <ArticleSection theme="neutral" id="comparison">
        ...
        <Prose>
          <p>
            Let's compare how you'd build this with traditional prop drilling:
          </p>
        </Prose>

        <ComparisonPanel orientation="vertical">
          <ComparisonPanel.Left
            title="Traditional Prop Drilling"
            color="danger"
          >
            <CodePanel
  ...
  return (
    <div>
      ...
      <button onClick={() => cubit.deleteTask(task.id)}>
        ...
        <Prose>
          <p>
            Notice how much cleaner the BlaC version is! The parent doesn't need
            to pass callbacks, and the child doesn't need to receive them.
            Everything "just works" through shared state.
          </p>
        </Prose>
      </ArticleSection>
      ...
      <ArticleSection theme="info" id="how-it-works">
        ...
        <Prose>
          <p>
            Every component that calls <code>useBloc(TaskListCubit)</code>{' '}
            connects to the <strong>same instance</strong>. When any component
            updates the state, BlaC notifies all connected components:
          </p>
          <ol>
            <li>
              <strong>Child calls method</strong>:{' '}
              <code>cubit.toggleTask(id)</code>
            </li>
            <li>
              <strong>State updates</strong>: Cubit emits new state with{' '}
              <code>patch()</code>
            </li>
            <li>
              <strong>All subscribers notified</strong>: BlaC notifies parent
              and all children
            </li>
            <li>
              <strong>React re-renders</strong>: Only components using the
              changed state re-render
            </li>
          </ol>
        </Prose>
  ...
  return (
    <button onClick={() => cubit.toggleTask(task.id)}>
      ...
      <ArticleSection theme="cubit" id="architecture">
        ...
        <Prose>
          <p>
            All three components use <code>useBloc(TaskListCubit)</code> to
            access the same shared instance. No props, no callbacks, no context
            providers—just simple, direct access.
          </p>
        </Prose>
      </ArticleSection>
      ...
      <ArticleSection theme="success" id="takeaways">
        ...
        <Prose>
          <ul>
            <li>
              <strong>No prop drilling</strong>: Child components access state
              directly
            </li>
            <li>
              <strong>Independent components</strong>: Each component connects
              to what it needs
            </li>
            <li>
              <strong>Cleaner code</strong>: No endless prop lists or callback
              chains
            </li>
            <li>
              <strong>Easy refactoring</strong>: Move components without
              rewiring props
            </li>
            <li>
              <strong>Better testing</strong>: Test components in isolation more
              easily
            </li>
            <li>
              <strong>Same instance</strong>: All components share one Cubit
              instance by default
            </li>
          </ul>
        </Prose>
      ...
      <ArticleSection theme="tip" id="next-steps">
        ...
        <Prose>
          <p>
            So far, we've seen how BlaC shares one instance across all
            components. But what if you want{' '}
            <strong>multiple independent instances</strong> of the same state?
          </p>
          <p>
            In the next demo, you'll learn about{' '}
            <strong>instance management</strong>—how to create isolated
            instances, when to use shared vs. isolated state, and how to control
            instance lifecycle.
          </p>
        </Prose>
      </ArticleSection>
