...
```typescript
export declare function generateSimpleId(
  prefix: string,
  affix?: string,
): string;
```
...
```typescript
export declare function getStaticProp<
  V,
...
```typescript
export declare function isExcludedFromDevTools<
...
```typescript
export declare function isIsolatedClass<T extends StateContainerConstructor>(
  Type: T,
): boolean;
```
...
```typescript
export declare function isKeepAliveClass<T extends StateContainerConstructor>(
  Type: T,
): boolean;
```
