            ...
            <div className="bg-white dark:bg-gray-900 p-6 rounded-lg border border-gray-200 dark:border-gray-700 shadow-md">
              <div className="flex flex-col lg:flex-row gap-4 items-center justify-center">
                ...
                <div className="flex flex-col lg:flex-row gap-4 items-center">
                  <div className="w-full max-w-[180px] rounded-lg bg-gradient-to-br from-green-500 to-green-600 p-0.5 transform transition-transform ">
                  ...
                  <div className="w-full max-w-[180px] rounded-lg bg-gradient-to-br from-yellow-500 to-yellow-600 p-0.5 transform transition-transform ">
                  ...
                  <div className="w-full max-w-[180px] rounded-lg bg-gradient-to-br from-red-500 to-red-600 p-0.5 transform transition-transform ">
