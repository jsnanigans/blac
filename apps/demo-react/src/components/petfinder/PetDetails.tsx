...
export const PetDetails: FC = () => {
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto" aria-labelledby="pet-details-modal" role="dialog" aria-modal="true">
      {/* Backdrop */}
      ...
      <div className="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:p-0">
        ...
        <div 
          ref={modalRef}
          className="relative inline-block align-bottom bg-white dark:bg-gray-800 rounded-3xl overflow-hidden shadow-xl transform transition-all sm:align-middle sm:max-w-2xl sm:w-full"
          tabIndex={-1}
        >
              ...
              {isDetailsLoading ? (
                ...
                <>
                  <div className="p-5 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center">
                    <h2 className="text-xl font-bold text-gray-800 dark:text-white flex items-center" id="pet-details-title">
