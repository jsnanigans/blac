    ...
    <div className="home">
      <header className="home-header">
        ...
        <p className="home-subtitle">
          Plug into a suite of high-voltage demos that show how Blac slices through
          complex state. Watch dependency tracking, lifecycle control, and instance
          orchestration react instantly as you interact.
        </p>
      </header>
      ...
      <div className="examples-grid">
        <Link to="/counter" className="example-card">
          ...
          <p>
            Calibrate your instincts with the essentials—observe Blac&apos;s reactive
            core as counts surge across shared and isolated channels.
          </p>
        ...
        <Link to="/shopping" className="example-card">
          ...
          <p>
            Immerse in event-driven flow where complex nested state morphs in sync
            with precise dispatch choreography.
          </p>
          <ul className="features-list">
        ...
        <Link to="/dashboard" className="example-card">
          ...
          <p>
            Watch render counters pulse only where metrics change. This is Blac&apos;s
            laser-cut dependency tracking on full display.
          </p>
          <ul className="features-list">
