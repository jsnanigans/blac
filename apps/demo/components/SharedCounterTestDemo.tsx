  ...
  return (
    <div>
      <p className="text-sm text-muted-foreground mb-4">
        Both components below use <code>useBloc(CounterCubit)</code> without any
        ID. Since CounterCubit doesn't have <code>static isolated = true</code>,
        they should share the same instance.
      </p>
      <SharedCounterComponentA />
      <SharedCounterComponentB />
      <p className="text-xs text-muted-foreground mt-2">
        Try incrementing from Component A or decrementing from Component B -
        both should update the same counter.
      </p>
    </div>
  );
};
